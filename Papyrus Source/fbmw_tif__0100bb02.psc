...
Scriptname FBMW_TIF__0100BB02 Extends TopicInfo Hidden
...
Game.GetPlayer().AddSpell(DCreatureSpell)
Game.GetPlayer().AddSpell(DHumanSpell)
...
SPELL Property DCreatureSpell  Auto  

SPELL Property DHumanSpell  Auto  

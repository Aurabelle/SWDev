Scriptname FBMW_MGAshSoulGemQuestScript extends Quest  Conditional

SoulGem Property QuestSoulGem  Auto  
...
Function QuestItemCounted()
	...
	float CurrentCount = Game.GetPlayer().GetItemCount(QuestSoulGem)

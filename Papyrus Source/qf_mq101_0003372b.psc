...
;BEGIN CODE
Game.GetPlayer().moveto(StartLocationMarker)
Game.DisablePlayerControls()
if ChooseStartLocationMessage.Show() == 0
	;skyrim
	MQQuickstartVar.SetValue(0)
	GameHour.SetValue(7)
	SetStage(10)
else
	;morrowind
...
Message Property ChooseStartLocationMessage  Auto  

GlobalVariable Property MQQuickstartVar  Auto  

ObjectReference Property StartLocationMarker  Auto  

ObjectReference Property SkywindStartLocation  Auto

MusicType Property MorrowindThemeMusic  Auto  

Cell Property StartLocationCell  Auto  

Quest Property Skywind  Auto  

...
Scriptname FBMW_TIF__0100EE56 Extends TopicInfo Hidden
...
akSpeaker.removeItem(RestoreBook, 1)
Game.GetPlayer().AddItem(RestoreBook, 1, false)
...
Book Property RestoreBook  Auto  

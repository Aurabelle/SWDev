...
Scriptname FBMW_QF_fbmwMTWritBrilnosu_0100F9B9 Extends Quest Hidden
...
;BEGIN ALIAS PROPERTY Brilnosu_Llarys
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_Brilnosu_Llarys Auto
;END ALIAS PROPERTY

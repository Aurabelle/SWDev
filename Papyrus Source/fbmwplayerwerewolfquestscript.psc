Scriptname fbmwPlayerWerewolfQuestScript extends Quest

; A modified Skyrim script for the werewolf change process
...
; Blocking this since Skywind doesn't use Skyrim shouts

Scriptname fbmwVampireDiseaseQuarraEffectScript  extends ActiveMagicEffect  
...
; 		Debug.Trace(self + "Player not in combat, and controls are enabled. Trigger Vampire change")
		PlayerVampireQuest.VampireChange(Game.GetPlayer(), VampireClan)
	Else
...
fbmwPlayerVampireQuestScript Property PlayerVampireQuest Auto

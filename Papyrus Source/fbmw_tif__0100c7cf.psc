...
Scriptname FBMW_TIF__0100C7CF Extends TopicInfo Hidden
...
;BEGIN CODE
;fbmwMTSanguineItems
fbmwMTSMartialCraft.start()
fbmwMTSMartialCraft.setStage(100)
...
Quest Property fbmwMTSMartialCraft  Auto  

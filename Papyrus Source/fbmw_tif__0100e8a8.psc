...
Scriptname FBMW_TIF__0100E8A8 Extends TopicInfo Hidden
...
;BEGIN CODE
;fbmwMTSanguineItems
fbmwMTSGoldenWisdom.start()
fbmwMTSGoldenWisdom.setStage(100)
...
Quest Property fbmwMTSGoldenWisdom  Auto  

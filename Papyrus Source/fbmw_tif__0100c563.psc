...
Scriptname FBMW_TIF__0100C563 Extends TopicInfo Hidden
...
Game.GetPlayer().RemoveItem(LinusAmulet, 1, false)
akSpeaker.addItem(LinusAmulet, 1, false)
Game.GetPlayer().RemoveItem(LinusBelt, 1, false)
akSpeaker.addItem(LinusBelt, 1, false)
...
Armor Property LinusAmulet  Auto  

Armor Property LinusBelt  Auto  
